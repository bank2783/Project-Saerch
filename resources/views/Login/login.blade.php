    ...
    <body class="antialiased">
        ...
        <div class="row">
            <div class="container mt-5">
                ...
                <form action="{{route('login_post')}}" method="POST" enctype="multipart/form-data" class="row col-xl-3 col-md-8 col-10 rounded-3 shadow-sm register-card">
                    @csrf
                    <span class="text-center fs-2 mt-3 text-primary">เข้าสู่ระบบ</span>
                    ...
                    <div class="col-12 mb-3 ">
                        ...
                        <input type="password" name="password" class="form-control border-white" placeholder="password">
                    </div>
