            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Curricolumn</h1>
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Curricolumn List</h6>
                ...
                <div class="modal-content">
                 <div class="modal-header">
                     <h1 class="modal-title fs-5" id="exampleModalLabel">Curricolumn Create</h1>
                     <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                     </div>
                     <div class="modal-body">
                        <form action="{{route('create_curricolumn')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <label for="exampleInputPassword1" class="form-label mt-2 ">Curricolumn name</label>
                            <input type="text" name="curricolumn_name"  class="form-control" required id="exampleInputPassword1">

                            <label for="exampleInputPassword1" class="form-label mt-2 ">Curricolumn Descript</label>
                            <input type="text" name="curricolumn_description"  class="form-control" required id="exampleInputPassword1">

                            <label for="exampleInputPassword1" class="form-label mt-2 ">status</label>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                ...
                <th>Curricolumn name</th>
                <th>Curricolumn description</th>
        ...
        <tbody>
            ...
            <tr>
                <td>{{$row -> curricolumn_name}}</td>
                <td>{{$row -> curricolumn_description}}</td>
                ...
                <td>
                    ...
                    <div class="modal fade" id="updateModal{{$row->id}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="deleteModalLabel{{$row->id}}" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="updateModalLabel{{$row->id}}">Curricolumn Update</h1>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <h3>Update</h3>
                                    <form action="{{route('update_curricolumn')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="curricolumn_id" value="{{$row->id}}">

                                        <label class="form-label mt-2 ">Curricolumn_name</label>
                                        <input type="text" name="curricolumn_name"  class="form-control" required >

                                        <label class="form-label mt-2 ">Curricolumn_description</label>
                                        <input type="text" name="curricolumn_description"  class="form-control" required >
