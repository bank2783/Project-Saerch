        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <a href="{{route('show_tables')}}" class="btn btn-primary"><i class="bi bi-arrow-left me-1"></i>ย้อนกลับ</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Category Create
                                                    </h1>
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{ route('create_category') }}" method="POST"
                                                        ...
                                                        <label for="exampleInputPassword1"
                                                            class="form-label mt-2 ">Category Descript</label>
                                                        ...
                                                        <div class="modal fade" id="updateModal{{ $row->id }}"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <h3>Update</h3>
                                                                        <form action="{{ route('update_category') }}"
                                                                            method="POST"
                                                                            enctype="multipart/form-data">
                                                                            @csrf
                                                                            ...
                                                                            <label
                                                                                class="form-label mt-2 ">Category</label>
                                                                            <input type="text"
                                                                                value="{{ $row->category_name }}"
                                                                                name="category_name"
                                                                                class="form-control" required>

                                                                            <label class="form-label mt-2 ">Category
                                                                                description</label>
                                                                            <input type="text"
                                                                            ...
                                                                            <label
                                                                                class="form-label mt-2 ">status</label>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button"
                                                                            ...
                                                                            data-bs-dismiss="modal">Close</button>
                                                                        <form
                                                                            action="{{ route('delete_curricolumn') }}"
                                                                            method="POST"
                                                                            enctype="multipart/form-data">
                                                                            @csrf
                                                                            <input type="hidden"
